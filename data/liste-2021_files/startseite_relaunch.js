...
jQuery(document).ready(function() {
  ...
  /* SPLASH SCREEN / TdoT / Tag der offenen Tür 2021
  */
  date = new Date().getDate();

  if (
    1>2&&(date==26 || window.location.host.indexOf('iwww.entw')>=0 || getParameter("tdottest")=="1") && 
    (location.pathname=='/' || location.pathname=='/index.shtml' || location.pathname=='/intranet.shtml' || location.pathname=='/internet.shtml')) {
...
/*
     FILE ARCHIVED ON 21:06:43 Dec 08, 2022 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:36:19 Jan 28, 2024.
...
playback timings (ms):
  ...
  cdx.remote: 0.146
  esindex: 0.011
  LoadShardBlock: 244.561 (6)
  PetaboxLoader3.datanode: 212.932 (8)
  load_resource: 1374.69 (2)
  PetaboxLoader3.resolve: 1266.515 (2)
*/