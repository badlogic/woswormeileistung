...
if (!evalFilterFields) {
	function evalFilterFields(fbez) {
		...
		/* 	document.getElementById('filterForm'+fbez).jsMode.value = '';
		 document.getElementById('filterForm'+fbez).xdocumentUri.value = ''; */
	}
...
function LoadEnhancements() {    
 ...
 function InitializePage () {
    ...
    if (navigator.userAgent == 'MobileApp') {
     ...
     if (typeof(lightbox) != "undefined") {
		...
		var backurl=S_GET('backurl');
		  ...
		  if (backurl && !backurl.startsWith('//') && !backurl.includes('javascript')){
			  if (backurl.startsWith('https://web.archive.org/web/20210722193047/https://iwww.parlament.gv.at')||
			  backurl.startsWith('https://web.archive.org/web/20210722193047/https://www.parlament.gv.at')||
                          backurl.startsWith('https://web.archive.org/web/20210722193047/http://iwww.parlament.gv.at')||
                          backurl.startsWith('https://web.archive.org/web/20210722193047/http://www.parlament.gv.at')||
			  backurl.startsWith('https://web.archive.org/web/20210722193047/https://iwww.entw.parlament.gv.at')||
			  backurl.startsWith('https://web.archive.org/web/20210722193047/https://www.entw.parlament.gv.at') ||
			  backurl.startsWith('/') ) {
...
/*
     FILE ARCHIVED ON 19:30:47 Jul 22, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:31:04 Jan 28, 2024.
...
playback timings (ms):
  ...
  cdx.remote: 0.091
  esindex: 0.009
  LoadShardBlock: 275.082 (6)
  PetaboxLoader3.datanode: 332.247 (8)
  PetaboxLoader3.resolve: 154.66 (3)
  load_resource: 230.677 (2)
*/